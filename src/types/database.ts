  ...
  public: {
    Tables: {
      cf_users: {
        ...
        Insert: { id?: string; email: string; password_hash?: string | null; plan?: 'starter' | 'pro'; contracts_used?: number; contracts_limit?: number; stripe_customer_id?: string | null; subscription_status?: string | null; created_at?: string; updated_at?: string }
        Update: { id?: string; email?: string; password_hash?: string | null; plan?: 'starter' | 'pro'; contracts_used?: number; contracts_limit?: number; stripe_customer_id?: string | null; subscription_status?: string | null; created_at?: string; updated_at?: string }
      }
      cf_contracts: {
        Row: {
          id: string
