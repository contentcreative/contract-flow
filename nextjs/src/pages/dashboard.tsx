...
import { FileText, CreditCard, Settings, LogOut, Check, User, Crown, X, Save, Trash2, Eye, Pen, Copy, Clock, FileSignature, Zap, DollarSign, Lock } from 'lucide-react'
  ...
  useEffect(() => {
    const checkUser = async () => {
      ...
      if (profileData) {
        ...
        // Calculate trial days left (only for non-pro users)
        if (profileData.subscription_status !== 'pro' && profileData.trial_end_date) {
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-6xl mx-auto px-4 py-8">
          ...
          {trialDaysLeft !== null && trialDaysLeft > 0 && (
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-4 rounded-xl mb-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-purple-100 text-sm">
                    Unlock unlimited contracts and AI-powered generation. Offer ends soon.
                  </div>
                </div>
              </div>
              <button
          ...
          {trialDaysLeft !== null && trialDaysLeft <= 0 && plan !== 'pro' && (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-orange-600 text-sm">
                    Upgrade to Pro to unlock unlimited contracts and AI features.
                  </div>
                </div>
              </div>
              <button
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <div className="text-3xl font-bold">{plan === 'pro' ? 'Unlimited' : '1/mo'}</div>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm mb-8">
            ...
            <div className="grid md:grid-cols-6 gap-4">
              {[
                { type: 'Freelance', name: 'Freelance Agreement', desc: 'Contract for services', free: true },
                { type: 'SOW', name: 'Statement of Work', desc: 'Project details', free: true },
                { type: 'NDA', name: 'Non-Disclosure', desc: 'Protect info', free: true },
                { type: 'MSA', name: 'MSA', desc: 'Service framework', free: false },
                { type: 'Contractor', name: 'Contractor', desc: 'Hire contractor', free: false },
                { type: 'Consulting', name: 'Consulting', desc: 'Consultant agreement', free: false }
              ].map(({ type, name, desc, free }) => {
                const isLocked = plan !== 'pro' && !free
                return isLocked ? (
                  <button
                    key={type}
                    onClick={() => setShowUpgradeModal(true)}
                    className="p-4 border border-gray-200 rounded-xl hover:border-purple-500 hover:bg-purple-50 transition text-center opacity-60"
                  >
            ...
            {plan !== 'pro' && (
              <div className="mt-4 text-center">
                <button onClick={() => setShowUpgradeModal(true)} className="text-sm text-purple-600 hover:text-purple-700 font-medium">
                  🔒 Upgrade to unlock all 10 contract types →
                </button>
              </div>
            )}
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="font-medium flex items-center gap-2 mt-1">
                    ...
                    {plan === 'pro' ? `Pro - ${selectedCurrency === 'GBP' ? '£12' : selectedCurrency === 'USD' ? '$15' : '€14'}/mo` : 'Free - 1 contract/month'}
                  </div>
                  {plan === 'pro' && (
                    <button 
