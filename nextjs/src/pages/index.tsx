      ...
      <nav className="border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="/login" className="bg-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-700">
              Get Started
            </a>
          </div>
        </div>
      ...
      <section className="py-20 text-center px-4">
        <div className="max-w-3xl mx-auto">
          <Link href="/offer" className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-full text-sm font-medium mb-6 hover:from-blue-600 hover:to-purple-700 transition-all">
            ...
            <span className="font-semibold">3 Templates + 7-Day Pro Trial</span>
          ...
          <div className="flex justify-center gap-4">
            <Link href="/login" className="bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-blue-700 flex items-center gap-2">
              Get Started Free <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="/login" className="border border-gray-300 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-50">
              Start Free Trial
            </Link>
          </div>
          <p className="mt-4 text-sm text-gray-500">1 free contract/month • 3 templates • 7-Day Pro Trial • No credit card required</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="border-2 border-gray-200 rounded-2xl p-8">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-2"><Check className="w-5 h-5 text-green-500" /> 1 contract per month</li>
                <li className="flex items-center gap-2"><Check className="w-5 h-5 text-green-500" /> 3 contract templates</li>
                <li className="flex items-center gap-2"><Check className="w-5 h-5 text-green-500" /> PDF export (watermarked)</li>
                <li className="flex items-center gap-2"><Check className="w-5 h-5 text-green-500" /> 7-Day Pro Trial</li>
              </ul>
              <Link href="/login" className="w-full py-3 border border-gray-300 rounded-xl font-medium hover:bg-gray-50 text-center block">
                Get Started Free
              </Link>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border-2 border-blue-600 relative">
              ...
              <Link href="/login" className="w-full py-3 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-700 text-center block">
                Start Free Trial
              </Link>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: 'What contract types are included?', a: 'We support 3 FREE contract types: Freelance Agreement, NDA, and Statement of Work (SOW). Pro users get all 10 contract types including MSA, Consulting, Contractor, Fixed Price, Retainer, Quote, and Invoice.' },
